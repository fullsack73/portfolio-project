We're continuing our implementation of Code Structure Refactor - Frontend/Backend/Styles by implementing task group number 3:
...
- [ ] 3.0 Relocate and update backend files
  - [ ] 3.1 Create backend directory
    - Create `src/backend/` directory
  - [ ] 3.2 Move Python backend files
  ...
  - [ ] 3.4 Verify Python module resolution
