We're continuing our implementation of Code Structure Refactor - Frontend/Backend/Styles by implementing task group number 1:
...
- [ ] 1.0 Consolidate CSS files
  ...
  - [ ] 1.3 Move merged CSS to new location
